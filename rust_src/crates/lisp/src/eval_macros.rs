...
macro_rules! xsignal {
    ($symbol:expr) => {
        #[allow(unused_unsafe)]
        unsafe {
            $crate::eval::signal_rust($symbol, crate::generated::Qnil);
        }
    };
    ($symbol:expr, $($tt:tt)+) => {
        #[allow(unused_unsafe)]
...
macro_rules! wrong_type {
    ($pred:expr, $arg:expr) => {
        xsignal!($crate::generated::Qwrong_type_argument, $pred, $arg);
    };
}
...
macro_rules! error {
    ($str:expr) => {{
        #[allow(unused_unsafe)]
        let strobj = unsafe {
            $crate::generated::make_string($str.as_ptr() as *const ::libc::c_char,
                                      $str.len() as ::libc::ptrdiff_t)
        };
        xsignal!($crate::generated::Qerror, strobj);
    }};
    ($fmtstr:expr, $($arg:expr),*) => {{
        let formatted = format!($fmtstr, $($arg),*);
        #[allow(unused_unsafe)]
        let strobj = unsafe {
            $crate::generated::make_string(formatted.as_ptr() as *const ::libc::c_char,
...
macro_rules! defvar_lisp {
    ($field_name:ident, $lisp_name:expr, $value:expr) => {{
        #[allow(unused_unsafe)]
        unsafe {
            use $crate::generated::Lisp_Objfwd;

            static mut o_fwd: Lisp_Objfwd = Lisp_Objfwd {
                type_: $crate::generated::Lisp_Fwd_Type::Lisp_Fwd_Obj,
                objvar: unsafe { &$crate::generated::globals.$field_name as *const _ as *mut _ },
            };

            $crate::generated::defvar_lisp(
                &o_fwd,
                concat!($lisp_name, "\0").as_ptr() as *const libc::c_char,
            );
            $crate::generated::globals.$field_name = $value;
        }
    }};
}
...
macro_rules! defvar_bool {
    ($field_name:ident, $lisp_name:expr, $value:expr) => {{
        unsafe {
            use $crate::generated::Lisp_Boolfwd;

            static mut o_fwd: Lisp_Boolfwd = Lisp_Boolfwd {
                type_: $crate::generated::Lisp_Fwd_Type::Lisp_Fwd_Bool,
                boolvar: unsafe { &$crate::generated::globals.$field_name as *const _ as *mut _ },
            };

            $crate::generated::defvar_bool(
                &o_fwd,
                concat!($lisp_name, "\0").as_ptr() as *const libc::c_char,
            );
            $crate::generated::globals.$field_name = $value;
