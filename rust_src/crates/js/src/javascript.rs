...
use deno::deno_runtime as deno_runtime;
...
//     let mut worker = deno::worker::create_main_worker(&program, main_module.clone(), permissions);
...
//     let _flags = deno::flags::flags_from_vec(args.clone()).unwrap_or_else(|e| {
